...
- [#25](https://github.com/javidjamae/ffmpeg-micro-mcp/pull/25) [`b374e90`](https://github.com/javidjamae/ffmpeg-micro-mcp/commit/b374e90cf8ce64108208c0957531b5623a608c58) Thanks [@javidjamae](https://github.com/javidjamae)! - `transcode_and_wait` and `run_blueprint_and_wait` now return an MCP **error result** when the job or run finishes `failed` (or, for transcodes, `canceled`), instead of a success-shaped payload that merely contains the failed status.
